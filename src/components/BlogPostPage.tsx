            ...
            <div className="prose prose-lg prose-stone max-w-none">
              <ReactMarkdown
                ...
                components={{
                  ...
                  ul: ({node, ...props}) => <ul className="list-disc list-inside mb-6 space-y-2 text-stone-700 marker:text-stone-700" {...props} />,
                  ol: ({node, ...props}) => <ol className="list-decimal list-inside mb-6 space-y-2 text-stone-700 marker:text-stone-700" {...props} />,
