            ...
            <div className="prose prose-lg prose-stone max-w-none">
              <ReactMarkdown
                ...
                components={{
                  ...
                  ul: ({node, ...props}) => <ul className="list-disc pl-6 mb-6 space-y-1" style={{ color: '#44403c' }} {...props} />,
                  ol: ({node, ...props}) => <ol className="list-decimal pl-6 mb-6 space-y-1" style={{ color: '#44403c' }} {...props} />,
