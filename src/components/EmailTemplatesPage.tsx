...
const DEFAULT_TEMPLATES: EmailTemplate[] = [
  ...
  },
  {
    ...
    content: '<h2>Guest Profile Completed</h2>\n<p><strong>NAME:</strong> {firstName} {lastName}</p>\n<p><strong>EMAIL:</strong> {email}</p>\n<p><strong>PHONE:</strong> {phone}</p>\n<p><strong>PROFESSION:</strong> {profession}</p>\n<h3>Short Bio:</h3>\n<p>{shortBio}</p>\n<p><strong>PHOTO:</strong> {photoUrl}</p>\n<h3>Social Links:</h3>\n<ul>\n<li><strong>Website:</strong> {website}</li>\n<li><strong>Facebook:</strong> {facebook}</li>\n<li><strong>Instagram:</strong> {instagram}</li>\n<li><strong>LinkedIn:</strong> {linkedin}</li>\n<li><strong>YouTube:</strong> {guest_youtube_url}</li>\n</ul>',
    variables: ['firstName', 'lastName', 'email', 'phone', 'profession', 'shortBio', 'photoUrl', 'website', 'facebook', 'instagram', 'linkedin', 'guest_youtube_url'],
