import { Play, Clock, Eye, Menu, X } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <SEOHead
        ...
        canonical="https://www.inner-edge.com/emotional-release-techniques"
        ogUrl="https://www.inner-edge.com/emotional-release-techniques"
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/blog" className="text-slate-700 hover:text-teal-600 transition-colors font-medium">
                Blog
              </Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-slate-50 border-t border-slate-200">
            <div className="px-4 py-4 space-y-3">
              <Link
                to="/about"
                className="block w-full text-left text-slate-700 hover:text-teal-600 py-2 font-medium"
