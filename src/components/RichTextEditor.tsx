  ...
  const editor = useEditor({
    ...
    onCreate: ({ editor }) => {
      ...
      style.textContent = `
        ...
        .ProseMirror ul, .ProseMirror ol { margin: 1rem 0; padding-left: 1.5rem; color: #292524 !important; }
        .ProseMirror ul li, .ProseMirror ol li { margin: 0.5rem 0; color: #292524 !important; }
        .ProseMirror ul li p, .ProseMirror ol li p { color: #292524 !important; }
        .ProseMirror ul li::marker, .ProseMirror ol li::marker { color: #292524 !important; }
